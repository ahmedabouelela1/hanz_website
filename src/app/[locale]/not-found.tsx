  ...
  return (
    <section className="relative flex min-h-[70vh] items-center overflow-hidden pt-[68px]">
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12">
        ...
        <Link
          href="/en"
          className="mt-8 inline-flex items-center gap-2 bg-ink px-7 py-4 font-mono text-[11px] uppercase tracking-[0.16em] text-paper transition-colors hover:bg-accent"
        >
